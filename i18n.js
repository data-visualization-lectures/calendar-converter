...
const translations = {
  ja: {
    ...
    'heading.convert': '日付を変換',
    'label.wareki': '和暦（例: S49.9.24, 平成1年1月8日）',
    'label.seireki': '西暦（例: 2024/3/22, 1989-01-08）',
    ...
    'error.invalidFormat': '入力形式が不正です',
    'error.outOfRange': 'この日付は{era}の範囲外です',
    'error.noWareki': '対応する和暦がありません（昭和以降に対応）',
  ...
  en: {
    ...
    'heading.convert': 'Convert a Date',
    'label.wareki': 'Japanese Era (e.g., S49.9.24, Heisei 1.1.8)',
    'label.seireki': 'Western (e.g., 2024/3/22, 1989-01-08)',
    ...
    'error.invalidFormat': 'Invalid input format',
    'error.outOfRange': 'This date is outside the {era} era range',
    'error.noWareki': 'No corresponding Japanese era (Showa onward only)',
